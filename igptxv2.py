...
def exift():
    print()
    print("\033[1;91m[+]\033[1;92m Thanks for using \033[1;91migptxv2")
    sleep(0.14)
...
while True:
    ...
    if askx == '':
        ...
        try:
            huggingface_hub.api_key = (key) 
        
            response mistralai/Mistral-7B-v0.1= huggingface_hub.Completion.create(
